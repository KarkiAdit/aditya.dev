...
/** Same name as in `setHomeEntranceDismissedUntilEndOfLocalDay` — used by early inline script on `/`. */
export const HOME_ENTRANCE_COOKIE = "aditya_home_entrance_dismissed";
